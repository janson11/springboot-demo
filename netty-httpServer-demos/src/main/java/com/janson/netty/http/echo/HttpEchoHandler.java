package com.janson.netty.http.echo;

import com.alibaba.fastjson.JSONObject;
import com.janson.netty.common.http.HttpProtocolHelper;
...
public class HttpEchoHandler extends SimpleChannelInboundHandler<FullHttpRequest> {
    ...
    protected void channelRead0(ChannelHandlerContext ctx, FullHttpRequest request) throws Exception {
        ...
        // 3、获取请求头
        Map<String, Object> echoHandlers = new HashMap<String, Object>();
        HttpHeaders headers = request.headers();
        Iterator<Map.Entry<String, String>> hit = headers.entries().iterator();
        while (hit.hasNext()) {
            Map.Entry<String, String> header = hit.next();
            echoHandlers.put(header.getKey(), header.getValue());
        }
        echo.put("request headers", echoHandlers);
        /**
         * 获取uri请求参数
         */
        Map<String, Object> uriDatas = paramsFromUri(request);
        echo.put("paramsFormUri", uriDatas);
