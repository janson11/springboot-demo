 ...
 * @Description:
 * @Author: Janson
 * @Date: 2021/12/5 19:03
 **/
public class Base64Demo {
    public static void main(String[] args) {
        try {
            // 使用基本编码
            String base64encodedString = Base64.getEncoder().encodeToString("xiaoyunzi".getBytes("utf-8"));
            ...
            base64encodedString = Base64.getUrlEncoder().encodeToString("xioayunzi".getBytes("utf-8"));
